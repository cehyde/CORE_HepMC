...
\item 
int \mbox{\hyperlink{_deep__event_8cxx_aef7afda743b97967e360e6b61ee44cb0}{Event\+Light\+Cone}} ()
\item 
int \mbox{\hyperlink{_deep__event_8cxx_a0cf25c5323c6cb149bd6bfb540131fc6}{Get\+\_\+\+Event}} (int i\+Evt)
\item 
\mbox{\Hypertarget{_deep__event_8cxx_a4aa70090cf027810bc53a91e6d9a3fcf}\label{_deep__event_8cxx_a4aa70090cf027810bc53a91e6d9a3fcf}} 
...
File contains event-\/by-\/event generation functions for $e {}^{A}Z \to e\textnormal{\textquotesingle} {}^{A}Z \gamma$.
...
\mbox{\hyperlink{_deep__event_8cxx_a0cf25c5323c6cb149bd6bfb540131fc6}{Get\+\_\+\+Event()}} generates e Z-\/$>$e Z gammai events uniformly in phase space \[\left\{Q^2, y=q\cdot P/(k\cdot P), \phi_e, \cos(\theta_{\gamma\gamma}^{CM}), \phi_{\gamma\gamma}^{CM} \right\}\] Only basis 4-\/vectors e.\+g. $ n_q, \widetilde n_q, X_q, Y_q$ are boosted, all other variables are invariants.
...
\begin{align} {\tt vec4out}_{[0,1,2,3]} = {\tt vec4out}_\mu &= \epsilon_{\mu \nu \rho \sigma} {\tt vec1}^\nu {\tt vec2}^\rho {\tt vec3}^\sigma \nonumber \\ \epsilon_{0123} &= 1 \end{align} \mbox{\Hypertarget{_deep__event_8cxx_a0f43468217e9509857fbac36979decb1}\label{_deep__event_8cxx_a0f43468217e9509857fbac36979decb1}} 
